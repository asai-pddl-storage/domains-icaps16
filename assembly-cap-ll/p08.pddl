...
(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-29)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2A-26 BASE-2A-27 BASE-2A-28 BASE-2B-0 BASE-2B-1 BASE-2B-2 BASE-2B-3
  ...
  BASE-2B-25 BASE-2B-26 BASE-2B-27 BASE-2B-28 - BASE PART-2A-A-0 PART-2A-A-1
  ...
  PART-2A-A-26 PART-2A-A-27 PART-2A-A-28 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2
  ...
  PART-2A-B-27 PART-2A-B-28 PART-2A-C-0 PART-2A-C-1 PART-2A-C-2 PART-2A-C-3
  PART-2A-C-4 PART-2A-C-5 PART-2A-C-6 PART-2A-C-7 PART-2A-C-8 PART-2A-C-9
  PART-2A-C-10 PART-2A-C-11 PART-2A-C-12 PART-2A-C-13 PART-2A-C-14 PART-2A-C-15
  PART-2A-C-16 PART-2A-C-17 PART-2A-C-18 PART-2A-C-19 PART-2A-C-20 PART-2A-C-21
  PART-2A-C-22 PART-2A-C-23 PART-2A-C-24 PART-2A-C-25 PART-2A-C-26 PART-2A-C-27
  PART-2A-C-28 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2 PART-2B-A-3 PART-2B-A-4
  ...
  PART-2B-B-24 PART-2B-B-25 PART-2B-B-26 PART-2B-B-27 PART-2B-B-28 PART-2B-C-0
  ...
  PART-2B-C-25 PART-2B-C-26 PART-2B-C-27 PART-2B-C-28 - COMPONENT TRAY-A TRAY-B
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-28 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-28 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-28 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-28 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-28 BASE-2B-28) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-28) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-28) (FREE ARM1) (AT ARM1 TRAY-A)
