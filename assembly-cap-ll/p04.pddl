...
(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-9)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  BASE-2A-5 BASE-2A-6 BASE-2A-7 BASE-2A-8 BASE-2B-0 BASE-2B-1 BASE-2B-2
  BASE-2B-3 BASE-2B-4 BASE-2B-5 BASE-2B-6 BASE-2B-7 BASE-2B-8 - BASE
  PART-2A-A-0 PART-2A-A-1 PART-2A-A-2 PART-2A-A-3 PART-2A-A-4 PART-2A-A-5
  PART-2A-A-6 PART-2A-A-7 PART-2A-A-8 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2
  ...
  PART-2A-C-6 PART-2A-C-7 PART-2A-C-8 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2
  PART-2B-A-3 PART-2B-A-4 PART-2B-A-5 PART-2B-A-6 PART-2B-A-7 PART-2B-A-8
  PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-B-3 PART-2B-B-4 PART-2B-B-5
  PART-2B-B-6 PART-2B-B-7 PART-2B-B-8 PART-2B-C-0 PART-2B-C-1 PART-2B-C-2
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-8 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-8 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-8 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-8 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-A-8 BASE-2A-8) (COMPONENT-BASE PART-2A-B-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-B-1 BASE-2A-1) (COMPONENT-BASE PART-2A-B-2 BASE-2A-2)
  (COMPONENT-BASE PART-2A-B-3 BASE-2A-3) (COMPONENT-BASE PART-2A-B-4 BASE-2A-4)
  (COMPONENT-BASE PART-2A-B-5 BASE-2A-5) (COMPONENT-BASE PART-2A-B-6 BASE-2A-6)
  (COMPONENT-BASE PART-2A-B-7 BASE-2A-7) (COMPONENT-BASE PART-2A-B-8 BASE-2A-8)
  ...
  (COMPONENT-BASE PART-2A-C-8 BASE-2A-8) (COMPONENT-BASE PART-2B-A-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-A-1 BASE-2B-1) (COMPONENT-BASE PART-2B-A-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-A-3 BASE-2B-3) (COMPONENT-BASE PART-2B-A-4 BASE-2B-4)
  (COMPONENT-BASE PART-2B-A-5 BASE-2B-5) (COMPONENT-BASE PART-2B-A-6 BASE-2B-6)
  (COMPONENT-BASE PART-2B-A-7 BASE-2B-7) (COMPONENT-BASE PART-2B-A-8 BASE-2B-8)
  ...
  (COMPONENT-BASE PART-2B-B-8 BASE-2B-8) (COMPONENT-BASE PART-2B-C-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-C-1 BASE-2B-1) (COMPONENT-BASE PART-2B-C-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-C-3 BASE-2B-3) (COMPONENT-BASE PART-2B-C-4 BASE-2B-4)
  (COMPONENT-BASE PART-2B-C-5 BASE-2B-5) (COMPONENT-BASE PART-2B-C-6 BASE-2B-6)
  (COMPONENT-BASE PART-2B-C-7 BASE-2B-7) (COMPONENT-BASE PART-2B-C-8 BASE-2B-8)
  ...
  (AT BASE-2A-8 CARRY-IN) (FINISHED NOTHING-DONE BASE-2A-8)
  ...
  (AT BASE-2B-7 CARRY-IN) (FINISHED NOTHING-DONE BASE-2B-7)
  (AT BASE-2B-8 CARRY-IN) (FINISHED NOTHING-DONE BASE-2B-8) (FREE ARM1)
