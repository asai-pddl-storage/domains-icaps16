...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail2 ingredient148)
  (cocktail-part1 cocktail3 ingredient62)
  (cocktail-part2 cocktail3 ingredient126)
  (cocktail-part1 cocktail4 ingredient10)
  (cocktail-part2 cocktail4 ingredient121)
  (cocktail-part1 cocktail5 ingredient97)
  (cocktail-part2 cocktail5 ingredient20)
  (cocktail-part1 cocktail6 ingredient52)
  (cocktail-part2 cocktail6 ingredient165)
  (cocktail-part1 cocktail7 ingredient184)
  (cocktail-part2 cocktail7 ingredient117)
  (cocktail-part1 cocktail8 ingredient81)
  (cocktail-part2 cocktail8 ingredient109)
  (cocktail-part1 cocktail9 ingredient24)
  (cocktail-part2 cocktail9 ingredient72)
  (cocktail-part1 cocktail10 ingredient184)
 ...
 (:goal
  (and
     ...
     (contains shot13 ingredient130)
     (contains shot14 ingredient177)
     (contains shot15 ingredient186)
     (contains shot16 ingredient87)
     (contains shot17 ingredient134)
     (contains shot18 ingredient161)
     (contains shot19 ingredient8)
     (contains shot20 cocktail8)
     (contains shot21 ingredient44)
     (contains shot22 ingredient109)
     (contains shot23 ingredient102)
     (contains shot24 cocktail9)
     (contains shot25 ingredient68)
     (contains shot26 ingredient159)
     (contains shot27 ingredient47)
     (contains shot28 ingredient71)
     (contains shot29 ingredient63)
     (contains shot30 cocktail1)
     (contains shot31 cocktail4)
     (contains shot32 cocktail1)
     (contains shot33 cocktail7)
     (contains shot34 ingredient123)
     (contains shot35 ingredient142)
     (contains shot36 cocktail5)
     (contains shot37 ingredient72)
     (contains shot38 cocktail8)
     (contains shot39 ingredient105)
     (contains shot40 cocktail4)
     (contains shot41 ingredient38)
     (contains shot42 ingredient169)
     (contains shot43 cocktail10)
     (contains shot44 ingredient77)
     (contains shot45 ingredient95)
     (contains shot46 cocktail4)
     (contains shot47 ingredient121)
     (contains shot48 ingredient106)
     (contains shot49 cocktail7)
     (contains shot50 cocktail7)
     (contains shot51 cocktail6)
     (contains shot52 ingredient46)
     (contains shot53 cocktail1)
     (contains shot54 ingredient20)
     (contains shot55 ingredient62)
     (contains shot56 ingredient89)
     (contains shot57 ingredient4)
     (contains shot58 ingredient108)
     (contains shot59 cocktail7)
     (contains shot60 cocktail8)
     (contains shot61 ingredient139)
     (contains shot62 cocktail4)
     (contains shot63 cocktail10)
     (contains shot64 ingredient83)
     (contains shot65 cocktail8)
     (contains shot66 cocktail10)
     (contains shot67 cocktail6)
     (contains shot68 cocktail7)
     (contains shot69 ingredient179)
     (contains shot70 cocktail9)
     (contains shot71 ingredient175)
     (contains shot72 ingredient55)
     (contains shot73 ingredient129)
     (contains shot74 cocktail2)
     (contains shot75 ingredient99)
     (contains shot76 ingredient134)
     (contains shot77 ingredient152)
     (contains shot78 ingredient138)
     (contains shot79 ingredient109)
     (contains shot80 ingredient180)
     (contains shot81 ingredient88)
     (contains shot82 cocktail5)
     (contains shot83 ingredient7)
     (contains shot84 cocktail2)
     (contains shot85 cocktail6)
     (contains shot86 ingredient132)
     (contains shot87 ingredient177)
     (contains shot88 cocktail1)
     (contains shot89 ingredient49)
     (contains shot90 cocktail4)
     (contains shot91 ingredient22)
     (contains shot92 cocktail7)
     (contains shot93 ingredient41)
     (contains shot94 cocktail7)
     (contains shot95 ingredient13)
     (contains shot96 cocktail10)
     (contains shot97 cocktail1)
     (contains shot98 ingredient176)
     (contains shot99 cocktail1)
     (contains shot100 ingredient152)
     (contains shot101 ingredient178)
     (contains shot102 ingredient150)
     (contains shot103 ingredient45)
     (contains shot104 cocktail8)
     (contains shot105 cocktail6)
     (contains shot106 ingredient170)
     (contains shot107 cocktail1)
     (contains shot108 ingredient179)
     (contains shot109 ingredient160)
     (contains shot110 ingredient46)
     (contains shot111 cocktail10)
     (contains shot112 ingredient92)
     (contains shot113 cocktail9)
     (contains shot114 ingredient77)
     (contains shot115 cocktail9)
     (contains shot116 ingredient160)
     (contains shot117 cocktail9)
     (contains shot118 cocktail2)
     (contains shot119 cocktail6)
     (contains shot120 cocktail10)
     (contains shot121 ingredient143)
     (contains shot122 ingredient84)
     (contains shot123 ingredient4)
     (contains shot124 cocktail6)
     (contains shot125 cocktail5)
     (contains shot126 cocktail3)
     (contains shot127 ingredient11)
     (contains shot128 ingredient50)
