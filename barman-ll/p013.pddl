...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part1 cocktail2 ingredient74)
  (cocktail-part2 cocktail2 ingredient38)
  (cocktail-part1 cocktail3 ingredient88)
  (cocktail-part2 cocktail3 ingredient165)
  (cocktail-part1 cocktail4 ingredient25)
  (cocktail-part2 cocktail4 ingredient162)
  (cocktail-part1 cocktail5 ingredient3)
  (cocktail-part2 cocktail5 ingredient125)
  (cocktail-part1 cocktail6 ingredient176)
  (cocktail-part2 cocktail6 ingredient81)
  (cocktail-part1 cocktail7 ingredient122)
  (cocktail-part2 cocktail7 ingredient169)
 ...
 (:goal
  (and
     ...
     (contains shot13 ingredient93)
     (contains shot14 ingredient66)
     (contains shot15 cocktail10)
     (contains shot16 ingredient52)
     (contains shot17 ingredient130)
     (contains shot18 ingredient139)
     (contains shot19 cocktail8)
     (contains shot20 ingredient177)
     (contains shot21 ingredient76)
     (contains shot22 cocktail1)
     (contains shot23 cocktail9)
     (contains shot24 ingredient15)
     (contains shot25 ingredient139)
     (contains shot26 cocktail5)
     (contains shot27 cocktail5)
     (contains shot28 ingredient17)
     (contains shot29 cocktail2)
     (contains shot30 ingredient56)
     (contains shot31 ingredient162)
     (contains shot32 cocktail6)
     (contains shot33 ingredient121)
     (contains shot34 ingredient22)
     (contains shot35 cocktail1)
     (contains shot36 cocktail7)
     (contains shot37 cocktail6)
     (contains shot38 ingredient124)
     (contains shot39 ingredient131)
     (contains shot40 ingredient42)
     (contains shot41 cocktail5)
     (contains shot42 ingredient146)
     (contains shot43 cocktail6)
     (contains shot44 cocktail3)
     (contains shot45 ingredient121)
     (contains shot46 cocktail5)
     (contains shot47 cocktail9)
     (contains shot48 cocktail7)
     (contains shot49 cocktail1)
     (contains shot50 ingredient166)
     (contains shot51 ingredient36)
     (contains shot52 ingredient113)
     (contains shot53 ingredient49)
     (contains shot54 ingredient97)
     (contains shot55 cocktail8)
     (contains shot56 ingredient171)
     (contains shot57 ingredient30)
     (contains shot58 cocktail7)
     (contains shot59 cocktail6)
     (contains shot60 ingredient86)
     (contains shot61 cocktail2)
     (contains shot62 ingredient27)
     (contains shot63 cocktail10)
     (contains shot64 ingredient60)
     (contains shot65 ingredient174)
     (contains shot66 ingredient64)
     (contains shot67 ingredient127)
     (contains shot68 cocktail5)
     (contains shot69 ingredient67)
     (contains shot70 ingredient76)
     (contains shot71 cocktail6)
     (contains shot72 ingredient25)
     (contains shot73 cocktail4)
     (contains shot74 cocktail2)
     (contains shot75 ingredient51)
     (contains shot76 ingredient15)
     (contains shot77 ingredient178)
     (contains shot78 cocktail8)
     (contains shot79 ingredient79)
     (contains shot80 cocktail1)
     (contains shot81 cocktail4)
     (contains shot82 ingredient109)
     (contains shot83 ingredient31)
     (contains shot84 cocktail5)
     (contains shot85 ingredient169)
     (contains shot86 ingredient131)
     ...
     (contains shot94 cocktail6)
     (contains shot95 cocktail5)
     (contains shot96 ingredient158)
     (contains shot97 ingredient177)
     (contains shot98 cocktail6)
     (contains shot99 ingredient106)
     (contains shot100 cocktail6)
     (contains shot101 ingredient79)
     (contains shot102 cocktail3)
     (contains shot103 cocktail5)
     (contains shot104 cocktail10)
     (contains shot105 cocktail7)
     (contains shot106 cocktail7)
     (contains shot107 ingredient64)
     (contains shot108 ingredient157)
     (contains shot109 ingredient27)
     (contains shot110 ingredient121)
     (contains shot111 cocktail10)
     (contains shot112 ingredient27)
     (contains shot113 ingredient134)
     (contains shot114 cocktail7)
     (contains shot115 cocktail5)
     (contains shot116 ingredient63)
     (contains shot117 ingredient105)
     (contains shot118 ingredient186)
     (contains shot119 cocktail7)
     (contains shot120 ingredient135)
     (contains shot121 ingredient62)
     (contains shot122 ingredient93)
     (contains shot123 ingredient125)
     (contains shot124 cocktail9)
     (contains shot125 cocktail6)
     (contains shot126 cocktail7)
     (contains shot127 ingredient190)
     (contains shot128 ingredient45)
     (contains shot129 cocktail6)
     (contains shot130 cocktail4)
     (contains shot131 ingredient163)
     (contains shot132 ingredient66)
     (contains shot133 cocktail9)
     (contains shot134 cocktail8)
     (contains shot135 ingredient83)
     (contains shot136 cocktail6)
     (contains shot137 cocktail2)
     (contains shot138 ingredient66)
     (contains shot139 cocktail5)
     (contains shot140 cocktail9)
     (contains shot141 ingredient141)
     (contains shot142 ingredient32)
     (contains shot143 ingredient93)
     (contains shot144 cocktail1)
     (contains shot145 ingredient152)
     (contains shot146 cocktail1)
     (contains shot147 ingredient184)
     (contains shot148 cocktail5)
     (contains shot149 cocktail1)
     (contains shot150 cocktail9)
     (contains shot151 cocktail9)
     (contains shot152 ingredient27)
     (contains shot153 cocktail4)
     (contains shot154 cocktail8)
     (contains shot155 cocktail3)
     (contains shot156 ingredient112)
     (contains shot157 ingredient144)
     (contains shot158 cocktail6)
     (contains shot159 ingredient188)
     (contains shot160 cocktail6)
     (contains shot161 ingredient108)
     (contains shot162 cocktail4)
     (contains shot163 cocktail3)
     (contains shot164 ingredient12)
     (contains shot165 ingredient86)
     ...
     (contains shot171 cocktail9)
     (contains shot172 ingredient45)
     (contains shot173 ingredient136)
     (contains shot174 cocktail3)
     (contains shot175 ingredient181)
     (contains shot176 ingredient125)
     (contains shot177 cocktail6)
     (contains shot178 ingredient116)
     (contains shot179 cocktail10)
     (contains shot180 cocktail6)
     (contains shot181 ingredient48)
     (contains shot182 cocktail1)
     (contains shot183 ingredient180)
     (contains shot184 ingredient123)
     (contains shot185 ingredient37)
     (contains shot186 cocktail4)
