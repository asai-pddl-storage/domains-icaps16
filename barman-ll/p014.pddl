...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part1 cocktail2 ingredient109)
  (cocktail-part2 cocktail2 ingredient183)
  (cocktail-part1 cocktail3 ingredient188)
  (cocktail-part2 cocktail3 ingredient155)
  (cocktail-part1 cocktail4 ingredient53)
  (cocktail-part2 cocktail4 ingredient149)
  (cocktail-part1 cocktail5 ingredient98)
  (cocktail-part2 cocktail5 ingredient188)
  (cocktail-part1 cocktail6 ingredient5)
  (cocktail-part2 cocktail6 ingredient128)
  ...
  (cocktail-part1 cocktail9 ingredient30)
  (cocktail-part2 cocktail9 ingredient148)
 ...
 (:goal
  (and
     ...
     (contains shot12 ingredient121)
     (contains shot13 cocktail3)
     (contains shot14 ingredient102)
     (contains shot15 ingredient146)
     (contains shot16 ingredient8)
     (contains shot17 ingredient48)
     (contains shot18 ingredient56)
     (contains shot19 ingredient65)
     (contains shot20 cocktail10)
     (contains shot21 cocktail1)
     (contains shot22 cocktail6)
     (contains shot23 cocktail8)
     (contains shot24 cocktail8)
     (contains shot25 ingredient106)
     (contains shot26 cocktail10)
     (contains shot27 cocktail2)
     (contains shot28 ingredient51)
     (contains shot29 cocktail8)
     (contains shot30 cocktail6)
     (contains shot31 cocktail8)
     (contains shot32 ingredient7)
     (contains shot33 ingredient176)
     (contains shot34 cocktail10)
     (contains shot35 ingredient48)
     (contains shot36 ingredient42)
     (contains shot37 ingredient185)
     (contains shot38 ingredient157)
     ...
     (contains shot45 ingredient69)
     (contains shot46 cocktail4)
     (contains shot47 cocktail1)
     (contains shot48 ingredient49)
     (contains shot49 cocktail3)
     (contains shot50 ingredient44)
     ...
     (contains shot56 ingredient155)
     (contains shot57 cocktail8)
     (contains shot58 cocktail2)
     (contains shot59 ingredient72)
     (contains shot60 ingredient185)
     (contains shot61 cocktail3)
     (contains shot62 ingredient91)
     (contains shot63 cocktail1)
     (contains shot64 ingredient133)
     (contains shot65 ingredient115)
     (contains shot66 ingredient92)
     (contains shot67 cocktail10)
     (contains shot68 ingredient123)
     (contains shot69 ingredient181)
     (contains shot70 cocktail2)
     (contains shot71 cocktail4)
     (contains shot72 cocktail1)
     (contains shot73 cocktail9)
     (contains shot74 ingredient181)
     (contains shot75 cocktail4)
     (contains shot76 ingredient37)
     (contains shot77 cocktail1)
     (contains shot78 cocktail9)
     (contains shot79 cocktail6)
     (contains shot80 ingredient41)
     (contains shot81 cocktail6)
     (contains shot82 ingredient79)
     (contains shot83 ingredient163)
     (contains shot84 cocktail5)
     (contains shot85 cocktail4)
     (contains shot86 cocktail8)
     (contains shot87 cocktail3)
     (contains shot88 cocktail6)
     (contains shot89 ingredient105)
     (contains shot90 ingredient90)
     (contains shot91 ingredient16)
     (contains shot92 cocktail5)
     (contains shot93 ingredient12)
     (contains shot94 ingredient26)
     (contains shot95 cocktail5)
     (contains shot96 cocktail5)
     (contains shot97 ingredient72)
     (contains shot98 cocktail5)
     (contains shot99 cocktail8)
     (contains shot100 ingredient15)
     (contains shot101 ingredient187)
     (contains shot102 cocktail7)
     (contains shot103 ingredient123)
     (contains shot104 cocktail3)
     (contains shot105 cocktail6)
     (contains shot106 ingredient111)
     (contains shot107 ingredient120)
     (contains shot108 cocktail8)
     (contains shot109 cocktail8)
     (contains shot110 cocktail10)
     (contains shot111 ingredient65)
     (contains shot112 ingredient111)
     (contains shot113 cocktail5)
     (contains shot114 cocktail10)
     (contains shot115 cocktail9)
     (contains shot116 cocktail4)
     (contains shot117 cocktail10)
     (contains shot118 cocktail2)
     (contains shot119 ingredient65)
     (contains shot120 ingredient87)
     (contains shot121 ingredient174)
     (contains shot122 cocktail2)
     (contains shot123 ingredient58)
     (contains shot124 ingredient68)
     (contains shot125 ingredient2)
     (contains shot126 cocktail10)
     (contains shot127 cocktail1)
     (contains shot128 ingredient59)
     (contains shot129 ingredient110)
     (contains shot130 ingredient86)
     (contains shot131 cocktail3)
     (contains shot132 cocktail8)
     (contains shot133 ingredient49)
     (contains shot134 cocktail4)
     (contains shot135 cocktail7)
     (contains shot136 cocktail2)
     (contains shot137 cocktail8)
     (contains shot138 ingredient189)
     (contains shot139 cocktail3)
     (contains shot140 ingredient24)
     (contains shot141 ingredient160)
     (contains shot142 ingredient176)
     (contains shot143 cocktail7)
     (contains shot144 cocktail8)
     (contains shot145 cocktail2)
     (contains shot146 ingredient174)
     (contains shot147 ingredient58)
     ...
     (contains shot153 cocktail2)
     (contains shot154 cocktail8)
     (contains shot155 ingredient147)
     (contains shot156 cocktail10)
     (contains shot157 ingredient43)
     (contains shot158 ingredient150)
     (contains shot159 cocktail9)
     (contains shot160 cocktail1)
     (contains shot161 ingredient103)
     (contains shot162 cocktail7)
     (contains shot163 cocktail9)
     (contains shot164 cocktail10)
     (contains shot165 ingredient37)
     (contains shot166 cocktail5)
     (contains shot167 cocktail5)
     (contains shot168 cocktail4)
     (contains shot169 ingredient16)
     (contains shot170 ingredient77)
     (contains shot171 cocktail8)
     (contains shot172 cocktail4)
     (contains shot173 ingredient74)
     (contains shot174 cocktail6)
     (contains shot175 cocktail9)
     (contains shot176 cocktail8)
     (contains shot177 cocktail10)
     (contains shot178 ingredient92)
     (contains shot179 ingredient93)
     (contains shot180 cocktail7)
     (contains shot181 cocktail2)
     (contains shot182 cocktail10)
     (contains shot183 ingredient54)
     (contains shot184 ingredient94)
     (contains shot185 cocktail6)
     (contains shot186 cocktail1)
     (contains shot187 cocktail6)
     (contains shot188 ingredient38)
     (contains shot189 cocktail5)
     (contains shot190 cocktail3)
     (contains shot191 ingredient33)
     (contains shot192 ingredient149)
     (contains shot193 cocktail10)
     (contains shot194 cocktail6)
     (contains shot195 ingredient104)
     (contains shot196 ingredient52)
     (contains shot197 ingredient182)
     (contains shot198 cocktail4)
     (contains shot199 ingredient55)
     (contains shot200 ingredient97)
     (contains shot201 ingredient77)
     (contains shot202 ingredient112)
     (contains shot203 ingredient167)
     (contains shot204 cocktail10)
     (contains shot205 ingredient104)
     (contains shot206 cocktail3)
     (contains shot207 cocktail1)
     (contains shot208 ingredient25)
     (contains shot209 ingredient93)
     (contains shot210 cocktail1)
     (contains shot211 ingredient134)
     (contains shot212 ingredient96)
     (contains shot213 cocktail1)
     (contains shot214 ingredient77)
     (contains shot215 cocktail9)
     (contains shot216 cocktail1)
     (contains shot217 ingredient134)
     (contains shot218 cocktail3)
     (contains shot219 ingredient86)
     (contains shot220 ingredient76)
     (contains shot221 ingredient71)
     (contains shot222 cocktail3)
     (contains shot223 cocktail7)
     (contains shot224 ingredient44)
     (contains shot225 ingredient65)
     (contains shot226 cocktail8)
     (contains shot227 ingredient104)
     (contains shot228 cocktail4)
     (contains shot229 ingredient182)
     (contains shot230 ingredient66)
     (contains shot231 ingredient137)
     (contains shot232 ingredient93)
     (contains shot233 ingredient137)
     (contains shot234 cocktail10)
     (contains shot235 ingredient10)
     (contains shot236 cocktail4)
     (contains shot237 cocktail6)
     (contains shot238 ingredient94)
     (contains shot239 ingredient50)
     (contains shot240 cocktail6)
     (contains shot241 cocktail5)
     (contains shot242 cocktail5)
     (contains shot243 cocktail4)
     (contains shot244 cocktail6)
     (contains shot245 cocktail2)
     (contains shot246 ingredient175)
     (contains shot247 ingredient172)
     (contains shot248 ingredient99)
