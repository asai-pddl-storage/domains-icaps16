...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part1 cocktail4 ingredient117)
  (cocktail-part2 cocktail4 ingredient41)
  (cocktail-part1 cocktail5 ingredient64)
