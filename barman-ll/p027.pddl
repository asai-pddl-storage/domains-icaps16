...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail40 ingredient6)
  ...
  (cocktail-part1 cocktail71 ingredient8)
  ...
  (cocktail-part2 cocktail112 ingredient5)
 ...
 (:goal
  (and
     ...
     (contains shot2 cocktail106)
     (contains shot3 cocktail80)
     ...
     (contains shot10 cocktail113)
     (contains shot11 cocktail12)
     (contains shot12 cocktail109)
     (contains shot13 cocktail103)
     (contains shot14 cocktail31)
     (contains shot15 cocktail100)
     ...
     (contains shot24 cocktail111)
     (contains shot25 cocktail79)
     ...
     (contains shot31 cocktail90)
     (contains shot32 cocktail121)
     (contains shot33 cocktail53)
     (contains shot34 cocktail130)
     ...
     (contains shot40 cocktail34)
     (contains shot41 cocktail39)
     (contains shot42 cocktail86)
     (contains shot43 cocktail17)
     (contains shot44 cocktail89)
     (contains shot45 cocktail59)
     (contains shot46 cocktail26)
     (contains shot47 cocktail77)
     (contains shot48 cocktail120)
     (contains shot49 cocktail65)
     (contains shot50 cocktail6)
     ...
     (contains shot82 cocktail88)
     (contains shot83 cocktail36)
     (contains shot84 cocktail41)
     (contains shot85 cocktail101)
     (contains shot86 cocktail116)
     (contains shot87 cocktail74)
     (contains shot88 cocktail56)
     (contains shot89 cocktail126)
     (contains shot90 cocktail11)
     (contains shot91 cocktail92)
     (contains shot92 cocktail37)
     (contains shot93 cocktail67)
     (contains shot94 cocktail25)
     (contains shot95 cocktail44)
     (contains shot96 cocktail40)
     (contains shot97 cocktail55)
     (contains shot98 cocktail76)
     (contains shot99 cocktail61)
     (contains shot100 cocktail78)
     (contains shot101 cocktail91)
     (contains shot102 cocktail97)
     (contains shot103 cocktail85)
     (contains shot104 cocktail4)
     (contains shot105 cocktail57)
     (contains shot106 cocktail115)
     (contains shot107 cocktail24)
     (contains shot108 cocktail58)
     (contains shot109 cocktail68)
     (contains shot110 cocktail18)
     (contains shot111 cocktail10)
     (contains shot112 cocktail19)
     (contains shot113 cocktail73)
     (contains shot114 cocktail51)
     (contains shot115 cocktail98)
     (contains shot116 cocktail117)
     (contains shot117 cocktail14)
     (contains shot118 cocktail128)
     (contains shot119 cocktail81)
     (contains shot120 cocktail47)
     (contains shot121 cocktail50)
     (contains shot122 cocktail87)
     (contains shot123 cocktail69)
     (contains shot124 cocktail7)
     (contains shot125 cocktail70)
     (contains shot126 cocktail104)
     (contains shot127 cocktail84)
     (contains shot128 cocktail118)
     (contains shot129 cocktail28)
     (contains shot130 cocktail46)
)))
