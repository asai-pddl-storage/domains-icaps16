...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail47 ingredient8)
 ...
 (:goal
  (and
     ...
     (contains shot38 cocktail59)
     (contains shot39 cocktail53)
     (contains shot40 cocktail21)
     ...
     (contains shot54 cocktail60)
     (contains shot55 cocktail43)
     (contains shot56 cocktail25)
     (contains shot57 cocktail9)
     (contains shot58 cocktail28)
     (contains shot59 cocktail10)
     (contains shot60 cocktail15)
     (contains shot61 cocktail33)
     (contains shot62 cocktail48)
     (contains shot63 cocktail4)
     ...
     (contains shot181 ingredient10)
     (contains shot182 ingredient1)
