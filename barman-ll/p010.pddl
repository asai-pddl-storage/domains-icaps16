...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail9 ingredient68)
  (cocktail-part1 cocktail10 ingredient63)
  (cocktail-part2 cocktail10 ingredient46)
)
 (:goal
  (and
     ...
     (contains shot40 ingredient57)
     (contains shot41 ingredient87)
     (contains shot42 cocktail4)
     (contains shot43 ingredient28)
     (contains shot44 ingredient38)
     (contains shot45 cocktail9)
     (contains shot46 ingredient27)
