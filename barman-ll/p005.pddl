...
(define (problem prob)
 ...
 (:goal
  (and
     ...
     (contains shot34 ingredient5)
     (contains shot35 cocktail1)
     (contains shot36 ingredient9)
     (contains shot37 cocktail8)
     (contains shot38 ingredient3)
     (contains shot39 ingredient10)
     (contains shot40 ingredient2)
     (contains shot41 ingredient7)
     (contains shot42 cocktail4)
     (contains shot43 cocktail9)
     (contains shot44 ingredient5)
     (contains shot45 cocktail8)
     (contains shot46 ingredient3)
     (contains shot47 ingredient8)
     (contains shot48 ingredient6)
