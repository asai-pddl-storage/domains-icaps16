...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail6 ingredient41)
  (cocktail-part1 cocktail7 ingredient23)
  (cocktail-part2 cocktail7 ingredient53)
  (cocktail-part1 cocktail8 ingredient48)
  (cocktail-part2 cocktail8 ingredient43)
  (cocktail-part1 cocktail9 ingredient60)
 ...
 (:goal
  (and
     ...
     (contains shot17 ingredient38)
     (contains shot18 ingredient69)
     (contains shot19 ingredient23)
     (contains shot20 ingredient34)
     (contains shot21 cocktail9)
     (contains shot22 cocktail7)
     (contains shot23 ingredient60)
     (contains shot24 ingredient41)
     (contains shot25 cocktail1)
     (contains shot26 ingredient47)
     (contains shot27 cocktail8)
     (contains shot28 cocktail2)
     (contains shot29 ingredient18)
     (contains shot30 cocktail3)
     (contains shot31 cocktail3)
     (contains shot32 ingredient53)
     (contains shot33 ingredient6)
     (contains shot34 cocktail9)
     (contains shot35 ingredient39)
     (contains shot36 cocktail6)
     (contains shot37 cocktail6)
     (contains shot38 cocktail2)
     (contains shot39 ingredient14)
     (contains shot40 ingredient6)
     ...
     (contains shot47 ingredient9)
     (contains shot48 ingredient60)
     (contains shot49 ingredient64)
     (contains shot50 ingredient51)
     (contains shot51 ingredient7)
     (contains shot52 ingredient5)
     (contains shot53 ingredient26)
     (contains shot54 cocktail4)
     (contains shot55 ingredient8)
     (contains shot56 cocktail7)
     (contains shot57 cocktail4)
     (contains shot58 cocktail1)
     (contains shot59 ingredient33)
     (contains shot60 ingredient15)
     (contains shot61 ingredient56)
