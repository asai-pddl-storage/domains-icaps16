...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part1 cocktail2 ingredient196)
  (cocktail-part2 cocktail2 ingredient19)
  (cocktail-part1 cocktail3 ingredient15)
  (cocktail-part2 cocktail3 ingredient229)
  (cocktail-part1 cocktail4 ingredient75)
  (cocktail-part2 cocktail4 ingredient92)
  (cocktail-part1 cocktail5 ingredient234)
  (cocktail-part2 cocktail5 ingredient41)
  (cocktail-part1 cocktail6 ingredient158)
  (cocktail-part2 cocktail6 ingredient236)
  ...
  (cocktail-part1 cocktail9 ingredient250)
  (cocktail-part2 cocktail9 ingredient53)
  (cocktail-part1 cocktail10 ingredient116)
  (cocktail-part2 cocktail10 ingredient103)
)
 (:goal
  (and
     ...
     (contains shot11 ingredient228)
     (contains shot12 ingredient200)
     (contains shot13 ingredient176)
     (contains shot14 cocktail5)
     (contains shot15 cocktail5)
     (contains shot16 ingredient154)
     (contains shot17 ingredient79)
     (contains shot18 ingredient42)
     (contains shot19 ingredient11)
     (contains shot20 ingredient1)
     (contains shot21 cocktail4)
     (contains shot22 cocktail4)
     (contains shot23 ingredient238)
     (contains shot24 cocktail7)
     (contains shot25 cocktail4)
     (contains shot26 ingredient61)
     (contains shot27 ingredient49)
     (contains shot28 cocktail6)
     (contains shot29 ingredient196)
     (contains shot30 ingredient227)
     (contains shot31 cocktail1)
     (contains shot32 cocktail5)
     (contains shot33 cocktail10)
     (contains shot34 ingredient76)
     ...
     (contains shot40 ingredient125)
     (contains shot41 ingredient134)
     (contains shot42 ingredient169)
     (contains shot43 cocktail8)
     (contains shot44 cocktail5)
     (contains shot45 cocktail9)
     (contains shot46 ingredient185)
     (contains shot47 cocktail4)
     (contains shot48 ingredient133)
     (contains shot49 cocktail5)
     (contains shot50 ingredient56)
     (contains shot51 cocktail9)
     (contains shot52 ingredient31)
     (contains shot53 ingredient246)
     (contains shot54 ingredient249)
     (contains shot55 ingredient109)
     (contains shot56 cocktail8)
     (contains shot57 cocktail10)
     (contains shot58 cocktail9)
     (contains shot59 ingredient73)
     (contains shot60 cocktail3)
     (contains shot61 ingredient68)
     (contains shot62 ingredient111)
     (contains shot63 ingredient247)
     (contains shot64 ingredient201)
     (contains shot65 ingredient30)
     (contains shot66 cocktail9)
     (contains shot67 ingredient132)
     (contains shot68 cocktail4)
     (contains shot69 ingredient71)
     (contains shot70 ingredient57)
     (contains shot71 ingredient25)
     (contains shot72 ingredient40)
     (contains shot73 cocktail9)
     (contains shot74 ingredient86)
     (contains shot75 cocktail4)
     (contains shot76 ingredient221)
     (contains shot77 cocktail4)
     (contains shot78 cocktail1)
     (contains shot79 ingredient102)
     (contains shot80 cocktail8)
     (contains shot81 ingredient7)
     (contains shot82 cocktail10)
     (contains shot83 cocktail5)
     (contains shot84 cocktail3)
     (contains shot85 cocktail8)
     (contains shot86 cocktail10)
     (contains shot87 ingredient8)
     (contains shot88 cocktail5)
     (contains shot89 ingredient173)
     (contains shot90 cocktail10)
     (contains shot91 cocktail7)
     (contains shot92 cocktail4)
     (contains shot93 cocktail8)
     (contains shot94 cocktail3)
     (contains shot95 ingredient88)
     (contains shot96 cocktail3)
     (contains shot97 cocktail10)
     (contains shot98 ingredient191)
     (contains shot99 cocktail3)
     (contains shot100 ingredient211)
     (contains shot101 cocktail6)
     (contains shot102 ingredient122)
     (contains shot103 ingredient168)
     (contains shot104 cocktail9)
     (contains shot105 ingredient18)
     (contains shot106 ingredient49)
     (contains shot107 cocktail7)
     (contains shot108 cocktail2)
     (contains shot109 cocktail10)
     (contains shot110 ingredient60)
     (contains shot111 ingredient137)
     (contains shot112 ingredient246)
     (contains shot113 cocktail8)
     (contains shot114 cocktail3)
     (contains shot115 cocktail3)
     (contains shot116 ingredient127)
     (contains shot117 cocktail5)
     (contains shot118 cocktail4)
     (contains shot119 cocktail1)
     (contains shot120 ingredient111)
     (contains shot121 cocktail2)
     (contains shot122 cocktail10)
     (contains shot123 cocktail10)
     (contains shot124 cocktail9)
     (contains shot125 cocktail4)
     (contains shot126 cocktail2)
     (contains shot127 ingredient113)
     (contains shot128 ingredient188)
     (contains shot129 cocktail6)
     (contains shot130 cocktail7)
     (contains shot131 cocktail9)
     (contains shot132 ingredient97)
     (contains shot133 cocktail6)
     (contains shot134 cocktail6)
     (contains shot135 ingredient34)
     (contains shot136 ingredient201)
     (contains shot137 ingredient134)
     (contains shot138 cocktail7)
     (contains shot139 cocktail7)
     (contains shot140 ingredient227)
     (contains shot141 ingredient151)
     (contains shot142 cocktail6)
     (contains shot143 ingredient18)
     (contains shot144 ingredient78)
     (contains shot145 ingredient234)
     (contains shot146 cocktail8)
     (contains shot147 ingredient186)
     (contains shot148 ingredient203)
     (contains shot149 ingredient61)
     (contains shot150 ingredient53)
     (contains shot151 cocktail7)
     (contains shot152 cocktail6)
     (contains shot153 ingredient139)
     (contains shot154 cocktail1)
     (contains shot155 cocktail8)
     (contains shot156 ingredient212)
     (contains shot157 cocktail10)
     (contains shot158 ingredient126)
     (contains shot159 ingredient214)
     (contains shot160 cocktail2)
     (contains shot161 cocktail7)
     (contains shot162 cocktail5)
     (contains shot163 cocktail8)
     (contains shot164 cocktail4)
     (contains shot165 ingredient241)
     (contains shot166 cocktail7)
     (contains shot167 cocktail9)
     (contains shot168 ingredient146)
     (contains shot169 cocktail9)
     (contains shot170 cocktail8)
     (contains shot171 ingredient161)
     (contains shot172 cocktail9)
     (contains shot173 cocktail2)
     (contains shot174 ingredient177)
     (contains shot175 ingredient153)
     (contains shot176 cocktail4)
     (contains shot177 cocktail3)
     (contains shot178 ingredient114)
     (contains shot179 cocktail2)
     (contains shot180 ingredient162)
     (contains shot181 cocktail10)
     (contains shot182 cocktail7)
     (contains shot183 cocktail10)
     (contains shot184 cocktail2)
     (contains shot185 cocktail8)
     (contains shot186 ingredient245)
     (contains shot187 ingredient74)
     (contains shot188 ingredient156)
     (contains shot189 cocktail5)
     (contains shot190 cocktail3)
     (contains shot191 cocktail3)
     (contains shot192 ingredient98)
     (contains shot193 cocktail5)
     (contains shot194 ingredient208)
     (contains shot195 ingredient191)
     (contains shot196 ingredient33)
     (contains shot197 ingredient17)
     (contains shot198 cocktail9)
     (contains shot199 cocktail9)
     (contains shot200 cocktail10)
     (contains shot201 cocktail5)
     (contains shot202 ingredient28)
     (contains shot203 ingredient177)
     (contains shot204 cocktail9)
     (contains shot205 ingredient174)
     (contains shot206 ingredient40)
     (contains shot207 ingredient199)
     (contains shot208 cocktail5)
     (contains shot209 cocktail8)
     (contains shot210 cocktail2)
     (contains shot211 cocktail7)
     (contains shot212 ingredient121)
     (contains shot213 ingredient113)
     (contains shot214 cocktail9)
     (contains shot215 ingredient227)
     (contains shot216 ingredient250)
     (contains shot217 cocktail4)
     (contains shot218 cocktail10)
     (contains shot219 ingredient68)
     (contains shot220 cocktail7)
     (contains shot221 ingredient11)
     (contains shot222 cocktail2)
     (contains shot223 cocktail3)
     (contains shot224 cocktail2)
     (contains shot225 ingredient228)
     (contains shot226 ingredient77)
     (contains shot227 ingredient191)
     (contains shot228 ingredient118)
     (contains shot229 ingredient147)
     (contains shot230 ingredient62)
     (contains shot231 cocktail7)
     (contains shot232 ingredient23)
     (contains shot233 ingredient173)
     (contains shot234 ingredient21)
     (contains shot235 ingredient145)
     (contains shot236 ingredient67)
     (contains shot237 cocktail3)
     (contains shot238 ingredient51)
     (contains shot239 cocktail7)
     (contains shot240 cocktail10)
     (contains shot241 cocktail3)
     (contains shot242 cocktail6)
     (contains shot243 cocktail2)
     (contains shot244 cocktail9)
     (contains shot245 cocktail10)
     (contains shot246 cocktail4)
     (contains shot247 cocktail8)
     (contains shot248 cocktail5)
     (contains shot249 cocktail10)
))
