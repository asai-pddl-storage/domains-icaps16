...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail2 ingredient101)
  (cocktail-part1 cocktail3 ingredient104)
  (cocktail-part2 cocktail3 ingredient171)
  (cocktail-part1 cocktail4 ingredient116)
  (cocktail-part2 cocktail4 ingredient123)
  ...
  (cocktail-part2 cocktail7 ingredient137)
  (cocktail-part1 cocktail8 ingredient61)
  (cocktail-part2 cocktail8 ingredient22)
  (cocktail-part1 cocktail9 ingredient33)
  (cocktail-part2 cocktail9 ingredient107)
 ...
 (:goal
  (and
     ...
     (contains shot15 ingredient154)
     (contains shot16 cocktail7)
     (contains shot17 ingredient100)
     (contains shot18 ingredient86)
     (contains shot19 cocktail10)
     (contains shot20 cocktail10)
     (contains shot21 ingredient81)
     (contains shot22 ingredient120)
     (contains shot23 cocktail9)
     (contains shot24 cocktail3)
     (contains shot25 ingredient113)
     (contains shot26 ingredient168)
     (contains shot27 ingredient77)
     (contains shot28 cocktail8)
     (contains shot29 cocktail1)
     (contains shot30 ingredient63)
     (contains shot31 cocktail2)
     (contains shot32 ingredient154)
     (contains shot33 cocktail9)
     ...
     (contains shot45 ingredient75)
     (contains shot46 ingredient135)
     (contains shot47 cocktail6)
     (contains shot48 ingredient131)
     (contains shot49 ingredient3)
     (contains shot50 ingredient113)
     (contains shot51 cocktail8)
     (contains shot52 cocktail7)
     (contains shot53 cocktail4)
     (contains shot54 ingredient63)
     (contains shot55 cocktail5)
     (contains shot56 ingredient125)
     (contains shot57 cocktail8)
     (contains shot58 cocktail6)
     (contains shot59 cocktail4)
     (contains shot60 ingredient51)
     (contains shot61 ingredient77)
     (contains shot62 ingredient83)
     (contains shot63 cocktail7)
     (contains shot64 cocktail6)
