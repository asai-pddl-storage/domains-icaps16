...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part1 cocktail2 ingredient118)
  ...
  (cocktail-part1 cocktail11 ingredient97)
  (cocktail-part2 cocktail11 ingredient99)
  (cocktail-part1 cocktail12 ingredient62)
  ...
  (cocktail-part2 cocktail14 ingredient80)
  ...
  (cocktail-part1 cocktail36 ingredient48)
  (cocktail-part2 cocktail36 ingredient69)
  (cocktail-part1 cocktail37 ingredient54)
  (cocktail-part2 cocktail37 ingredient128)
  (cocktail-part1 cocktail38 ingredient78)
  (cocktail-part2 cocktail38 ingredient70)
  (cocktail-part1 cocktail39 ingredient99)
  (cocktail-part2 cocktail39 ingredient32)
  (cocktail-part1 cocktail40 ingredient48)
  (cocktail-part2 cocktail40 ingredient53)
  (cocktail-part1 cocktail41 ingredient58)
  (cocktail-part2 cocktail41 ingredient93)
  (cocktail-part1 cocktail42 ingredient58)
  (cocktail-part2 cocktail42 ingredient115)
  (cocktail-part1 cocktail43 ingredient7)
  (cocktail-part2 cocktail43 ingredient24)
  (cocktail-part1 cocktail44 ingredient92)
  (cocktail-part2 cocktail44 ingredient78)
  (cocktail-part1 cocktail45 ingredient53)
  (cocktail-part2 cocktail45 ingredient52)
  (cocktail-part1 cocktail46 ingredient130)
  (cocktail-part2 cocktail46 ingredient128)
  (cocktail-part1 cocktail47 ingredient42)
  (cocktail-part2 cocktail47 ingredient96)
  (cocktail-part1 cocktail48 ingredient93)
  (cocktail-part2 cocktail48 ingredient108)
  (cocktail-part1 cocktail49 ingredient120)
  (cocktail-part2 cocktail49 ingredient35)
  (cocktail-part1 cocktail50 ingredient30)
  (cocktail-part2 cocktail50 ingredient15)
  (cocktail-part1 cocktail51 ingredient48)
  (cocktail-part2 cocktail51 ingredient73)
  ...
  (cocktail-part1 cocktail57 ingredient57)
  (cocktail-part2 cocktail57 ingredient60)
  (cocktail-part1 cocktail58 ingredient19)
  (cocktail-part2 cocktail58 ingredient39)
  (cocktail-part1 cocktail59 ingredient82)
  (cocktail-part2 cocktail59 ingredient15)
  (cocktail-part1 cocktail60 ingredient103)
  (cocktail-part2 cocktail60 ingredient99)
  (cocktail-part1 cocktail61 ingredient62)
  (cocktail-part2 cocktail61 ingredient29)
  (cocktail-part1 cocktail62 ingredient91)
  (cocktail-part2 cocktail62 ingredient23)
  (cocktail-part1 cocktail63 ingredient83)
  (cocktail-part2 cocktail63 ingredient61)
  (cocktail-part1 cocktail64 ingredient42)
  (cocktail-part2 cocktail64 ingredient101)
  (cocktail-part1 cocktail65 ingredient9)
  (cocktail-part2 cocktail65 ingredient61)
  (cocktail-part1 cocktail66 ingredient11)
  (cocktail-part2 cocktail66 ingredient80)
  (cocktail-part1 cocktail67 ingredient7)
  (cocktail-part2 cocktail67 ingredient68)
  (cocktail-part1 cocktail68 ingredient43)
  (cocktail-part2 cocktail68 ingredient29)
  (cocktail-part1 cocktail69 ingredient61)
  (cocktail-part2 cocktail69 ingredient116)
  (cocktail-part1 cocktail70 ingredient39)
  (cocktail-part2 cocktail70 ingredient120)
)
 (:goal
  (and
     (contains shot1 cocktail30)
     (contains shot2 cocktail69)
     (contains shot3 cocktail43)
     (contains shot4 cocktail56)
     (contains shot5 cocktail61)
     (contains shot6 cocktail13)
     (contains shot7 cocktail57)
     ...
     (contains shot19 cocktail64)
     (contains shot20 cocktail20)
     ...
     (contains shot49 cocktail65)
     (contains shot50 cocktail62)
     ...
     (contains shot58 cocktail67)
     (contains shot59 cocktail37)
     (contains shot60 cocktail48)
     (contains shot61 cocktail28)
     ...
     (contains shot67 cocktail29)
     (contains shot68 cocktail41)
     (contains shot69 cocktail27)
     (contains shot70 cocktail54)
     (contains shot71 ingredient56)
     (contains shot72 ingredient101)
     (contains shot73 ingredient64)
     (contains shot74 cocktail39)
     (contains shot75 cocktail37)
     (contains shot76 ingredient75)
     (contains shot77 cocktail67)
     (contains shot78 cocktail68)
     (contains shot79 ingredient93)
     (contains shot80 ingredient112)
     (contains shot81 ingredient112)
     (contains shot82 ingredient54)
     (contains shot83 ingredient71)
     (contains shot84 cocktail2)
     (contains shot85 ingredient49)
     (contains shot86 ingredient120)
     (contains shot87 ingredient12)
     (contains shot88 ingredient4)
     (contains shot89 cocktail67)
     (contains shot90 ingredient74)
     (contains shot91 cocktail38)
     (contains shot92 cocktail61)
     (contains shot93 ingredient44)
     (contains shot94 cocktail2)
     (contains shot95 ingredient18)
     (contains shot96 cocktail39)
     (contains shot97 cocktail41)
     (contains shot98 cocktail30)
     (contains shot99 cocktail52)
     (contains shot100 ingredient28)
     (contains shot101 ingredient50)
     (contains shot102 cocktail60)
     (contains shot103 ingredient16)
     (contains shot104 cocktail58)
     (contains shot105 cocktail66)
     (contains shot106 ingredient3)
     (contains shot107 ingredient14)
     (contains shot108 cocktail34)
     (contains shot109 cocktail20)
     (contains shot110 ingredient54)
     (contains shot111 ingredient14)
     (contains shot112 cocktail43)
     (contains shot113 cocktail28)
     (contains shot114 cocktail26)
     (contains shot115 ingredient119)
     (contains shot116 ingredient42)
     (contains shot117 cocktail59)
     (contains shot118 ingredient112)
     (contains shot119 ingredient114)
     (contains shot120 cocktail48)
     (contains shot121 ingredient108)
     (contains shot122 cocktail6)
     (contains shot123 ingredient88)
     (contains shot124 cocktail44)
     (contains shot125 cocktail55)
     (contains shot126 cocktail48)
     (contains shot127 cocktail51)
     (contains shot128 ingredient91)
     (contains shot129 ingredient83)
     (contains shot130 ingredient4)
     (contains shot131 ingredient116)
     (contains shot132 ingredient77)
     (contains shot133 ingredient53)
     (contains shot134 ingredient78)
     (contains shot135 cocktail8)
     (contains shot136 ingredient76)
     (contains shot137 cocktail35)
     (contains shot138 cocktail33)
     (contains shot139 cocktail16)
     (contains shot140 ingredient13)
     (contains shot141 cocktail15)
     (contains shot142 ingredient114)
     (contains shot143 cocktail4)
     (contains shot144 ingredient85)
     (contains shot145 cocktail30)
     (contains shot146 ingredient104)
     (contains shot147 cocktail46)
     (contains shot148 cocktail33)
     (contains shot149 ingredient4)
     (contains shot150 ingredient65)
     (contains shot151 ingredient8)
     (contains shot152 cocktail62)
     (contains shot153 ingredient3)
     (contains shot154 cocktail55)
     (contains shot155 cocktail48)
     (contains shot156 ingredient65)
     (contains shot157 cocktail65)
     (contains shot158 ingredient47)
     (contains shot159 cocktail9)
     (contains shot160 ingredient95)
     (contains shot161 ingredient28)
     (contains shot162 cocktail28)
     (contains shot163 cocktail64)
     (contains shot164 cocktail38)
     (contains shot165 ingredient98)
     (contains shot166 cocktail51)
     (contains shot167 ingredient85)
     (contains shot168 cocktail27)
     (contains shot169 ingredient76)
     (contains shot170 cocktail5)
     (contains shot171 cocktail38)
     (contains shot172 ingredient120)
     (contains shot173 cocktail24)
     (contains shot174 cocktail7)
     (contains shot175 ingredient7)
     (contains shot176 cocktail13)
     (contains shot177 ingredient91)
     (contains shot178 ingredient126)
     (contains shot179 ingredient77)
     (contains shot180 ingredient36)
     (contains shot181 cocktail32)
     (contains shot182 cocktail14)
     (contains shot183 cocktail65)
     (contains shot184 cocktail46)
     (contains shot185 cocktail40)
     (contains shot186 cocktail65)
     (contains shot187 ingredient113)
     (contains shot188 cocktail4)
     (contains shot189 ingredient105)
     (contains shot190 ingredient66)
     (contains shot191 cocktail70)
     (contains shot192 ingredient4)
     (contains shot193 cocktail8)
     (contains shot194 ingredient47)
     (contains shot195 cocktail54)
     (contains shot196 cocktail18)
     (contains shot197 cocktail66)
     (contains shot198 ingredient41)
     (contains shot199 ingredient123)
     (contains shot200 cocktail63)
     (contains shot201 ingredient23)
     (contains shot202 cocktail33)
     (contains shot203 cocktail37)
     (contains shot204 cocktail15)
     (contains shot205 ingredient33)
     (contains shot206 ingredient78)
     (contains shot207 ingredient106)
     (contains shot208 ingredient69)
     (contains shot209 ingredient14)
     (contains shot210 cocktail17)
     (contains shot211 cocktail37)
     (contains shot212 cocktail23)
     (contains shot213 ingredient74)
     (contains shot214 ingredient109)
     (contains shot215 ingredient23)
     (contains shot216 ingredient110)
     (contains shot217 cocktail53)
     (contains shot218 cocktail50)
     (contains shot219 ingredient115)
     (contains shot220 ingredient47)
     (contains shot221 ingredient44)
     (contains shot222 cocktail38)
     (contains shot223 cocktail32)
     (contains shot224 ingredient37)
     (contains shot225 cocktail39)
     (contains shot226 cocktail3)
     (contains shot227 ingredient97)
     (contains shot228 cocktail36)
     (contains shot229 ingredient115)
     (contains shot230 ingredient45)
     (contains shot231 ingredient110)
     (contains shot232 ingredient12)
     (contains shot233 cocktail13)
     (contains shot234 ingredient30)
     (contains shot235 ingredient75)
     (contains shot236 cocktail18)
     (contains shot237 ingredient94)
     (contains shot238 cocktail15)
     (contains shot239 ingredient9)
     (contains shot240 cocktail35)
     (contains shot241 ingredient85)
     (contains shot242 cocktail19)
     (contains shot243 ingredient73)
     (contains shot244 cocktail41)
     (contains shot245 ingredient52)
     (contains shot246 cocktail28)
     (contains shot247 ingredient51)
     (contains shot248 cocktail70)
     (contains shot249 cocktail56)
))
