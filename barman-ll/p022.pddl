...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail6 ingredient55)
  ...
  (cocktail-part1 cocktail9 ingredient45)
 ...
 (:goal
  (and
     ...
     (contains shot19 ingredient23)
     (contains shot20 ingredient48)
     (contains shot21 ingredient1)
     (contains shot22 ingredient21)
     (contains shot23 cocktail9)
     (contains shot24 ingredient12)
     (contains shot25 ingredient19)
     (contains shot26 ingredient6)
     (contains shot27 ingredient43)
     (contains shot28 cocktail6)
     (contains shot29 ingredient31)
     (contains shot30 ingredient33)
     (contains shot31 cocktail6)
     (contains shot32 cocktail5)
     (contains shot33 ingredient20)
     (contains shot34 cocktail6)
     (contains shot35 ingredient6)
     (contains shot36 cocktail4)
     (contains shot37 ingredient42)
     (contains shot38 cocktail3)
     (contains shot39 cocktail10)
     (contains shot40 cocktail3)
     (contains shot41 ingredient4)
     (contains shot42 ingredient23)
     (contains shot43 ingredient57)
     (contains shot44 ingredient47)
     (contains shot45 ingredient69)
     (contains shot46 ingredient21)
     (contains shot47 cocktail2)
     (contains shot48 ingredient54)
     (contains shot49 cocktail7)
     (contains shot50 ingredient5)
     (contains shot51 cocktail7)
     (contains shot52 cocktail1)
     (contains shot53 ingredient12)
     (contains shot54 ingredient24)
     (contains shot55 cocktail9)
     (contains shot56 ingredient36)
     ...
     (contains shot66 ingredient22)
     (contains shot67 cocktail5)
     (contains shot68 cocktail10)
     (contains shot69 ingredient14)
     (contains shot70 ingredient61)
     (contains shot71 ingredient11)
     (contains shot72 cocktail6)
     (contains shot73 cocktail6)
     (contains shot74 ingredient30)
     ...
     (contains shot84 cocktail4)
     (contains shot85 ingredient26)
     (contains shot86 ingredient12)
     (contains shot87 cocktail8)
     (contains shot88 ingredient46)
     (contains shot89 ingredient68)
     (contains shot90 cocktail1)
     (contains shot91 cocktail7)
     (contains shot92 ingredient17)
     (contains shot93 ingredient57)
     (contains shot94 ingredient7)
     (contains shot95 ingredient21)
     (contains shot96 ingredient6)
     (contains shot97 cocktail8)
     (contains shot98 ingredient20)
     (contains shot99 cocktail1)
     (contains shot100 cocktail7)
     (contains shot101 ingredient59)
     (contains shot102 cocktail8)
     (contains shot103 ingredient34)
     (contains shot104 cocktail3)
     (contains shot105 cocktail9)
     (contains shot106 cocktail1)
     (contains shot107 ingredient58)
     (contains shot108 ingredient45)
     (contains shot109 ingredient59)
     (contains shot110 ingredient62)
     (contains shot111 ingredient43)
     ...
     (contains shot120 ingredient54)
     (contains shot121 cocktail2)
     (contains shot122 cocktail10)
     (contains shot123 cocktail5)
     (contains shot124 ingredient49)
     (contains shot125 ingredient49)
     (contains shot126 cocktail2)
     (contains shot127 ingredient16)
     (contains shot128 ingredient67)
