...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail22 ingredient8)
 ...
 (:goal
  (and
     ...
     (contains shot31 cocktail46)
     (contains shot32 cocktail44)
