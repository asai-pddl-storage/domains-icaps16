...
(define (problem prob)
 ...
 (:init 
  ...
  (cocktail-part2 cocktail2 ingredient178)
  (cocktail-part1 cocktail3 ingredient100)
  (cocktail-part2 cocktail3 ingredient29)
  (cocktail-part1 cocktail4 ingredient159)
  (cocktail-part2 cocktail4 ingredient81)
  (cocktail-part1 cocktail5 ingredient61)
  (cocktail-part2 cocktail5 ingredient174)
  (cocktail-part1 cocktail6 ingredient33)
  (cocktail-part2 cocktail6 ingredient223)
  (cocktail-part1 cocktail7 ingredient178)
  (cocktail-part2 cocktail7 ingredient151)
  (cocktail-part1 cocktail8 ingredient50)
  (cocktail-part2 cocktail8 ingredient62)
  (cocktail-part1 cocktail9 ingredient94)
  (cocktail-part2 cocktail9 ingredient93)
  (cocktail-part1 cocktail10 ingredient154)
  (cocktail-part2 cocktail10 ingredient170)
)
 (:goal
  (and
     ...
     (contains shot12 ingredient185)
     (contains shot13 ingredient250)
     (contains shot14 cocktail2)
     (contains shot15 cocktail1)
     (contains shot16 ingredient180)
     (contains shot17 cocktail9)
     (contains shot18 ingredient217)
     (contains shot19 ingredient58)
     (contains shot20 ingredient232)
     (contains shot21 cocktail8)
     (contains shot22 ingredient200)
     (contains shot23 cocktail9)
     (contains shot24 ingredient75)
     (contains shot25 cocktail6)
     (contains shot26 ingredient37)
     (contains shot27 ingredient46)
     (contains shot28 cocktail3)
     (contains shot29 cocktail2)
     (contains shot30 ingredient188)
     (contains shot31 ingredient134)
     (contains shot32 cocktail1)
     (contains shot33 ingredient48)
     (contains shot34 ingredient92)
     (contains shot35 ingredient196)
     (contains shot36 ingredient93)
     (contains shot37 ingredient189)
     (contains shot38 ingredient212)
     (contains shot39 ingredient140)
     (contains shot40 cocktail5)
     (contains shot41 ingredient72)
     (contains shot42 cocktail7)
     (contains shot43 cocktail10)
     (contains shot44 ingredient95)
     (contains shot45 cocktail8)
     (contains shot46 ingredient20)
     (contains shot47 ingredient238)
     (contains shot48 ingredient229)
     (contains shot49 ingredient144)
     (contains shot50 cocktail5)
     (contains shot51 ingredient84)
     (contains shot52 ingredient159)
     (contains shot53 cocktail1)
     (contains shot54 ingredient246)
     (contains shot55 cocktail7)
     (contains shot56 ingredient13)
     (contains shot57 cocktail5)
     (contains shot58 ingredient11)
     (contains shot59 cocktail8)
     (contains shot60 cocktail2)
     (contains shot61 cocktail8)
     (contains shot62 ingredient66)
     (contains shot63 cocktail1)
     (contains shot64 ingredient121)
     (contains shot65 cocktail3)
     (contains shot66 ingredient27)
     (contains shot67 cocktail5)
     (contains shot68 cocktail9)
     (contains shot69 ingredient10)
     (contains shot70 ingredient246)
     (contains shot71 ingredient91)
     (contains shot72 cocktail9)
     (contains shot73 cocktail10)
     (contains shot74 ingredient218)
     (contains shot75 cocktail4)
     (contains shot76 ingredient218)
     (contains shot77 ingredient149)
     (contains shot78 cocktail7)
     (contains shot79 ingredient234)
     (contains shot80 cocktail8)
     (contains shot81 ingredient3)
     (contains shot82 ingredient74)
     (contains shot83 cocktail5)
     (contains shot84 ingredient86)
     (contains shot85 ingredient167)
     (contains shot86 ingredient6)
     (contains shot87 ingredient123)
     (contains shot88 cocktail2)
     (contains shot89 ingredient52)
     (contains shot90 ingredient211)
     (contains shot91 ingredient227)
     (contains shot92 ingredient221)
     (contains shot93 ingredient158)
     (contains shot94 ingredient230)
     (contains shot95 cocktail7)
     (contains shot96 cocktail1)
     (contains shot97 ingredient127)
     (contains shot98 ingredient110)
     (contains shot99 cocktail5)
     (contains shot100 cocktail8)
     (contains shot101 ingredient115)
     (contains shot102 ingredient192)
     (contains shot103 cocktail8)
     (contains shot104 cocktail4)
     (contains shot105 ingredient126)
     (contains shot106 cocktail6)
     (contains shot107 cocktail4)
     (contains shot108 ingredient233)
     (contains shot109 ingredient220)
     ...
     (contains shot116 ingredient206)
     (contains shot117 ingredient194)
     (contains shot118 cocktail3)
     (contains shot119 ingredient96)
     (contains shot120 cocktail4)
     (contains shot121 ingredient86)
     (contains shot122 cocktail9)
     (contains shot123 ingredient166)
     (contains shot124 ingredient34)
     (contains shot125 cocktail2)
     (contains shot126 cocktail1)
     (contains shot127 cocktail7)
     (contains shot128 ingredient128)
     (contains shot129 ingredient231)
))
